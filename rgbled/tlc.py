...
CHANNEL_PER_CHIP = const(12)

_BUFFER_BYTES_PER_COLOR = const(2)
_BUFFER_BYTES_PER_PIXEL = const(6)

_BC_CHIP_BUFFER_BIT_OFFSET = const(0)
_BC_BIT_COUNT = const(21)
...
_FC_CHIP_BUFFER_BIT_OFFSET = const(21)
...
_WC_CHIP_BUFFER_BIT_OFFSET = const(26)
_WC_FIELDS = {
    "WRITE_COMMAND": {
        "offset": 0,
        "length": 6,
...
_CHIP_BUFFER_HEADER_BYTE_COUNT = const(4)
